      ...
      <div className="pricing-section">
        <div className="pricing-main">
          <div className="free-activities">
            ...
            <p className="retreat-note">Membership is ONLY necessary for the quarterly retreat</p>
          </div>
          
          <div className="price-card">
            <span className="price-number">$25</span>
            <span className="price-period">per quarter*</span>
            <span className="price-note">*Can pay anytime during the quarter</span>
      ...
      <div className="benefits-section">
        ...
        <div className="benefit-item">
            ...
            <div className="benefit-content">
              ...
              <p>Join us for our amazing quarterly retreats - often the highlight of the quarter!</p>
            </div>
          </div>
          <div className="benefit-item">
            ...
            <div className="benefit-content">
              ...
              <p>While we usually have space, typically only 20% of attendees drive. Membership ensures you&apos;ll have a space!</p>
            </div>
          </div>
          <div className="benefit-item">
          ...
          <div className="benefit-item">
            ...
            <div className="benefit-content">
              ...
              <p>Any membership in the 25-26 academic year grants access to board elections, as well as potential voting rights for event and retreat details.</p>
            </div>
          </div>
          <div className="benefit-item">
            ...
            <div className="benefit-content">
              ...
              <p>Your membership helps us fund all of our awesome events and maintain camping gear that we loan to members.</p>
            </div>
          </div>
        </div>
      </div>
