const pastEvents: AACEvent[] = [
  {
    ...
    description:
      "AAC hiked Eucalyptus Trail in Chino Hills, a scenic 3.2-mile hike through rolling green hills! We also visited BAPS Shri Swaminarayan Mandir.",
  ...
  },
  {
    ...
    description:
      "On Saturday, we took a trip to the coast and visited Balboa Island & Pier! It was a scenic day at the beach, complete with a ferry ride across the water, and lunch at Ruby's Diner!",
